...
export const fetchTopArtist = async () => {
  try {
    ...
    const response = await axios.get(BASE_URL + '/me/top/artists?limit=50&time_range=long_term', {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
...
export const fetchTopTrack = async () => {
  try {
    ...
    const response = await axios.get(BASE_URL + '/me/top/tracks?limit=50&time_range=long_term', {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
