export const Account = ({ color = '#fff' }) => {
  return (
    <svg
...
export const TopArtist = ({ color = '#fff' }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export const TopTrack = ({ color = '#fff' }) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
...
export const Playlist = ({ color = '#fff' }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
